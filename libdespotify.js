...
var void_ptr = ref.refType(ref.types.void); // void *
var char = ref.types.char;             // char
var char4096 = ArrayType(char, 4096);  // char[4096]
var char256  = ArrayType(char, 256 );  // char[256]
var char41   = ArrayType(char, 41  );  // char[41]
var char35   = ArrayType(char, 35  );  // char[35]
var char33   = ArrayType(char, 33  );  // char[33]
var char_ptr = ref.refType(char);      // char *
var char_ptrArr = ArrayType(char_ptr); // char **
...
/**
 * union type that represents the "data" parameter in the "session callback"
 */
